    ...
    */
    ...
    function register()
    {
        ...
        {	
            ...
            $mobileno = (isset($values['mobile']) ? $values['mobile'] : false);
                ...
                if (!$this->CI->config->item('FAL_register_direct'))
                {
                    ...
                    if (($query != null) && ($query->num_rows() > 0))
                    {
                     ...
                     //   $this->_sendActivationEmail($user_id, $username, $password_email, $email, $activation_code);
                        $this->CI->smsapi->sendMessage($user_id, $username, $password_email, $mobileno, $activation_code);
    ...
    function getRegistrationForm()
    {
        ...
        $values['dob'] = $this->CI->input->post('year').'/'.$this->CI->input->post('month').'/'.$this->CI->input->post('Date');
        $values['gender'] = $this->CI->input->post('gender');
         $values['mobile'] = $this->CI->input->post('mobile');
