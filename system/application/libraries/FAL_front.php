...
class Fal_front
{
    ...
    /**
     *  handles the site logout first and then redirects to facebook logout url
     */
    function fblogout()
    {
    	$this->CI->freakauth_light->fblogout();
    }
	// --------------------------------------------------------------------
    ...
    {	
        ...
        else
        {
            ...
            $fields['mobile'] = $this->CI->lang->line('FAL_user_mobile_label');
            ...
            $rules['mobile'] = $this->CI->config->item('FAL_user_mobileno_field_validation_register');
        ...
        if ($this->CI->fal_validation->run() && $userid = $this->CI->freakauth_light->register())
        {
    ...
    {	
        ...
        if ($this->CI->freakauth_light->activation($this->CI->uri->segment(3, 0), $this->CI->uri->segment(4, $this->CI->input->post('activationcode'))))
        {
    ...
    function checkAndSetfbId($details)
    {
    	return $this->CI->usermodel->CheckAndSetFbDetails($details);
    }
}